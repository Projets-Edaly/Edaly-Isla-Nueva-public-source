...
As part of our ongoing effort to preserve and share the development history of the **Libertad** mod, we are now **releasing the unbinarized source files of Isla Nueva**.
...
- Complete **Terrain Builder** project files  
- Original **L3DT** terrain generation sources  
- Full satellite, mask, and heightmap source files  
- **Substance Painter** satmap project files  
- Terrain textures, materials, and terrain configuration files  
- **Terrain Processor** resources and vegetation distribution setups  
...
- Internal or external development tools, executables, or conversion utilities  
- Bohemia Interactive proprietary tools *(packing, conversion, terrain utilities, etc.)*  
- Third-party redistributables or dependencies *(such as `ijl15.dll`)*  
- Certain temporary, cached, deprecated, or unrelated development leftovers  
